...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login">
		<a href="index.html"><img src="<c:url value="/resources/images/shared/logo.png" />" width="490" height="108" alt="" /></a>
	</div>
	<!-- end logo -->
	...
	<form action="<c:url value='j_spring_security_check' />" method='POST'>
		...
		<tr>
			<th><spring:message code="label.login.login"/></th>
