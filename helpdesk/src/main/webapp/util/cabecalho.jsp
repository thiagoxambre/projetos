...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="listarSistemas"><b>Sistemas</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li><a href="listarSistemas">Listar Sistemas</a></li>
				<li class="sub_show"><a href="formAdicionarSistema">Adicionar Sistema</a></li>
		...
		<ul class="select"><li><a href="listarModulos"><b>Módulos</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="listarModulos">Listar Módulos</a></li>
				<li><a href="formAdicionarModulo">Adicionar Módulo</a></li>
		...
		<ul class="select"><li><a href="listarEmpresas"><b>Empresas</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="listarEmpresas">Listar Empresas</a></li>
				<li><a href="formAdicionarEmpresa">Adicionar Empresa</a></li>
		...
		<ul class="select"><li><a href="listarTipoChamados"><b>Tipos de Chamados</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="listarTipoChamados">Listar Tipos de Chamado</a></li>
				<li><a href="formAdicionarTipoChamado">Adicionar Tipo de Chamado</a></li>
		...
		<ul class="select"><li><a href="listarUsuarios"><b>Usuários</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="listarUsuarios">Listar Usuarios</a></li>
				<li><a href="formAdicionarUsuario">Adicionar Usuário</a></li>
